...
UPDATE MG_SALES_DATA_FINAL  
SET ORDER_EXTRACT=SUBSTRING(ORDER_ID,9);

SELECT  ORDER_ID , ORDER_EXTRACT FROM MG_SALES_DATA_FINAL;
...
SELECT ORDER_ID , ORDER_DATE, SHIP_DATE , PROCESS_DAYS FROM MG_SALES_DATA_FINAL ; 
